...
// Categories routes (Created as a resource controller by `php artisan make:model ... -mrc` creating a migration, model, and controller)
Route::resource('/categories', CategoryController::class); // Handles all requests
// index, create, store, show, edit, update, destroy are implicitly handled.
